...
$req = 'SELECT image,title,autor,posting_date,content,article_id FROM article ORDER BY posting_date DESC';

$count = $bdd->query($req);

$article = $count->fetchAll(PDO::FETCH_ASSOC);

$reqcours = 'SELECT id,sujet,date,image,niveau,matiere,description FROM cours ORDER BY date DESC';
                 ...
                 ?>
                        <div class="blog_item">
                            ...
                            <div class="blog_details">
                                ...
                                <a href="cours.php?id=<?=$value['id']?>">Accéder au cours<i class="icofont-long-arrow-right"></i></a>
                            </div>
                        </div>
                        <?php    }
                         ?>
